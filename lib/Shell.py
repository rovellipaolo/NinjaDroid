##
# @file Shell.py
# @brief Parser for shell commands.
# @version 1.0
...
class Shell(Signature, object):
    ...
    #
    # @param signatures  Signature regex in an hash, whose keys are the ones declared in _SIGNATURE_KEYS_LIST (i.e. {"commands": [...], "dirs": [...]}).
    #
    @classmethod
